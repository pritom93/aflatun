    ...
    <nav id="sidebar">
        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            ...
            <li class="nav-item theme-text">
                <a href="{{url('admins')}}" class="nav-link"> AFLATUN </a>
            </li>
        </ul>
        {{--end Logo area --}}
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu active">
                ...
                <ul class="collapse submenu recent-submenu mini-recent-submenu list-unstyled show" id="dashboard"
                    ...
                    <li>
                        <a href="{{url('admin/newadmin')}}"> New Admin </a>
                    </li>
                </ul>
            </li>
            {{--end Dashboard --}}
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="components" data-parent="#accordionExample">
                    <li>
                        <a href="{{url('admins/admin_view')}}"> Admins List </a>
                    </li>
                    <li>
                        <a href="{{url('admins/unit_view')}}"> Unit </a>
                    </li>
                    <li>
                        <a href="{{url('admins/category_view')}}"> Category </a>
                    </li>
                    <li>
                        <a href="{{url('admins/products_view')}}">Products</a>
                    </li>
                    <li>
                        <a href="{{url('admins/brands_view')}}"> Brands</a>
                    </li>
                    <li>
