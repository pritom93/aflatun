            ...
            <div class="card-body">
                <form id="attrValueFormID" method="">
                    ...
                    <div class="form-row">
                        ...
                        <div class="value">
                            <div class="input-group">
                                <input class="input--style-5" type="text" value="" id="ValmainNameID"
                                    name="ValmainNameID">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="value">
                            <div class="input-group">
                                <input class="input--style-5" type="text" value="" id="AttrValDesID"
                                    name="AttrValDesID">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="value">
                            <div class="input-group">
                                <input class="input--style-5" type="number" value="" id="AttrCountID"
                                    name="AttrCountID">
                            </div>
                        </div>
                    </div>
