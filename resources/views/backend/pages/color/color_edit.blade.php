                ...
                <div class="form-row">
                    ...
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" type="text" value="{{$color->color_name}}" id="ColorName"
                                name="ColorIDName">
                        </div>
                        <input type="hidden" value="{{$color->id}}" id="COLORhiddenID">
                    </div>
                </div>
                <div class="form-row">
                    <div class="name">colorCode with #</div>
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" type="text" value="{{$color->color_code}}" id="colorID"
                                name="colorjID">
                        </div>
                    </div>
                </div>
