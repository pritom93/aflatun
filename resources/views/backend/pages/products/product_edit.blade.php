        ...
        <div class="card-body">
            <form id="ProductFormID">
                ...
                <div class="form-row">
                    ...
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" type="number" value="{{$products->unit_id}}" id="UnitName"
                                name="UnitIDName">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" type="number" value="{{$products->category_id}}"
                                id="CategoryName" name="CategoryIDName">
                        </div>
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" value="{{$products->product_name}}" type="text"
                                id="ProductName" name="ProducIDtName">
                        </div>
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" type="number" value="{{$products->product_price}}"
                                id="ProductPrice" name="ProductIDPrice">
                        </div>
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" type="text" value="{{$products->product_description}}"
                                id="DescriptionProduct" name="DescriptionIDProduct">
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="form-row">
                    ...
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" value="{{$products->product_available_quantity}}"
                                type="number" id="ProductQNTY" name="ProductIDQNTY">
                        </div>
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" value="{{$products->product_size}}" type="text"
                                id="SizeProduct" name="SizeIDProduct">
                        </div>
                    </div>
                </div>
                <div class="form-row">
                        ...
                        <div class="input-group">
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select id="ProductPromoted" name="subject">
                                    <option value="{{$products->promoted_item}}">{{$products->promoted_item}}</option>
                ...
                <div class="form-row">
                    ...
                    <div class="value">
                        <div class="input-group">
                            <input class="form-check-input" type="checkbox" value="" id="ProductColor">pink
                            <input type="hidden" value="{{$products->id}}" id="productHiddenID">
                        </div>
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" type="text" value="{{$products->vat}}" id="ProductVAT"
                                name="ProductVAT">
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function(){
        $('#ProductFormID').submit(function(event){
            ...
            let ProductData = new FormData();
                ...
                ProductData.append('id', $('#productHiddenID').val());
