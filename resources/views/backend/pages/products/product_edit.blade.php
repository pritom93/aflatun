            ...
            <div class="card-body">
                <form id="combinationForm">
                    <div class="form-row mb-4">
                        ...
                        <div class="form-group col-md-4">
                            <label for="category">Category "{{$products->category_id}}"</label>
                        ...
                        <div class="form-group col-md-4">
                            <label for="inputUnit">Unit "{{$products->unit_id}}"</label>
                        ...
                        <div class="form-row mb-4 combination-row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <select class="form-control size-select">
                                    ...
                                    @foreach ($attrvaluessize as $value)
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <select class="form-control color-select">
                                    ...
                                    @foreach ($attrvaluescolor as $value)
                                    <option value="{{$value->id}}">{{$value->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-row mb-4">
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control" type="number" value="{{$products->product_price}}" id="ProductPrice" name="ProductIDPrice">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="category">VAT</label>
                            <input class="form-control" type="number" value="{{$products->vat}}" id="ProductVAT" name="ProductVAT">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="category">QTY</label>
                            <input class="form-control" type="number" value="{{$products->product_available_quantity}}" id="ProductQNTY" name="ProductIDQNTY">
                        </div>
                        <div class="form-group col-md-3">
