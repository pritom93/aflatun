...
<div class="col-xl-12 col-md-12 col-sm-12 col-12">
    ...
    <div class="card card-5">
        ...
        <div class="card-body">
            <form id="SizeFormID" method="">

                <div class="form-row">
                    <div class="name">Size Name</div>
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" type="text" value="" id="SizeName" name="SizeIDName">
                        </div>
                    </div>
                </div>
                <div class="form-row">
                    <div class="name">Size Code</div>
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" type="text" value="" id="SizeID" name="SizeID">
                        </div>
                    </div>
                </div>
                <div>
...
<script>
    ...
    $('#SizeFormID').submit(function(event){
