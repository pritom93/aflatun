...
<div class="col-xl-12 col-md-12 col-sm-12 col-12">
    ...
    <div class="card card-5">
        ...
        <div class="card-body">
            <form id="unitFormUpdate">

                <div class="form-row">
                    <div class="name">Unit Name</div>
                    <div class="value">
                        <div class="input-group">
                            <input class="input--style-5" type="text" value="{{$units->unit_name}}" id="unitName"
                                name="unitName">
                            <input class="input--style-5" type="hidden" value="{{$units->id}}" id="UnitHiddenID">
                        </div>
                    </div>
                </div>
                <div>
...
<script>
    ...
    $('#unitFormUpdate').submit(function(event){
        event.preventDefault();

        var unitName = $('#unitName').val();
        var id = $('#UnitHiddenID').val();
        let data = {
            name: unitName,
            id: id,
        };
