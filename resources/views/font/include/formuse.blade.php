...
{{-- <script>
    function assingMaker(oderId){
        const makerId = document.getElementById("makerman-"+oderId).value
        const delivId = document.getElementById("deliveryman-"+oderId).value
        const status = document.getElementById("status-"+oderId).value
        const position = document.getElementById("position-"+oderId).value
        const dt = {
            id: oderId,
            maker : makerId,
            deliveryman: delivId,
